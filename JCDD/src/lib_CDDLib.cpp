...
JNIEXPORT jlong JNICALL Java_lib_CDDLib_applyReset
  (JNIEnv *env, jclass, jlong cdd_pointer, jintArray clock_resets, jintArray clock_values, jintArray bool_resets, jintArray bool_values){
    ...
    auto converted_clock_resets = helper_functions::jintToCIntArray(env, clock_resets, num_clock_resets);
    auto converted_clock_values = helper_functions::jintToCIntArray(env, clock_values, num_clock_resets);
    ...
    printf("converted_bool_resets %i \n" , converted_bool_resets[0]);
    printf("converted_bool_values %i \n" , converted_bool_values[0]);
...
JNIEXPORT jintArray JNICALL Java_lib_CDDLib_getValuesFromBDDArray
  (JNIEnv *env, jclass, jlong bdd_arrays_pointer){
    ...
    int size = bdd_arrays_object->numTraces * bdd_arrays_object->numBools;
    return helper_functions::cPointerToJavaArray(env, bdd_arrays_object->values, size);
}


/*
 * Class:     lib_CDDLib
 * Method:    getNumBoolsFromBDDArray
 */
JNIEXPORT jint JNICALL Java_lib_CDDLib_getNumBoolsFromBDDArray
  (JNIEnv *env, jclass, jlong bdd_arrays_pointer){
    bdd_arrays* bdd_arrays_object = (bdd_arrays*)bdd_arrays_pointer;
    return bdd_arrays_object->numBools;
}


/*
 * Class:     lib_CDDLib
 * Method:    getNumTracesFromBDDArray
 */
JNIEXPORT jint JNICALL Java_lib_CDDLib_getNumTracesFromBDDArray
  (JNIEnv *env, jclass, jlong bdd_arrays_pointer){
    bdd_arrays* bdd_arrays_object = (bdd_arrays*)bdd_arrays_pointer;
